...
```{r}
daily = read.csv("SydneyDailyWeatherObservations/IDCJDW2124.202406-202507.csv", header = TRUE)
rainfall = read.csv("Rainfall/IDCJAC0009_066214_1800_Data.csv", header = TRUE)
maxTemp = read.csv("MaxTemp/IDCJAC0010_066214_1800_Data.csv", header = TRUE)
minTemp = read.csv("MinTemp/IDCJAC0011_066214_1800_Data.csv", header = TRUE)
```
